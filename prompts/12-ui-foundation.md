...
## Задача
0. **Если UI-kit уже сделан** через [DESIGN-uikit.md](DESIGN-uikit.md) — бери значения токенов, раскладку атласа и спеку 9-patch оттуда: они точнее, чем выведенные из текста спеки. Если нет — работай по docs/01 §4 как раньше.
